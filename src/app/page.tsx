...
type CharacterData = typeof CHARACTERS[keyof typeof CHARACTERS];
...
export default function App() {
  ...
  const handleSubmit = () => {
    ...
    const char = (CHARACTERS as Record<string, typeof CHARACTERS[keyof typeof CHARACTERS]>)[trimmed];
    if (char) {
      setCharacter(char);
      setError("");
      ...
      <div style={{
        ...
        <div style={{ position: "relative", textAlign: "center", maxWidth: 480 }}>
          ...
          <button
            ...
            onMouseEnter={e => { (e.target as HTMLButtonElement).style.background = "rgba(46,117,182,0.25)"; (e.target as HTMLButtonElement).style.color = "#8bbde8"; }}
            onMouseLeave={e => { (e.target as HTMLButtonElement).style.background = "rgba(46,117,182,0.15)"; (e.target as HTMLButtonElement).style.color = "#6ba3d6"; }}
    ...
    <div style={{
      ...
      <div style={{ maxWidth: 640, margin: "0 auto", padding: "0 20px" }}>
        {SECTION_ORDER.map((key, i) => {
          ...
          const content = (character.sections as Record<string, string>)[key];
          ...
          return (
            <div key={key} style={{
              ...
              >
                <span style={{ fontSize: 16 }}>{(SECTION_ICONS as Record<string, string>)[key]}</span>
                <span>{key}</span>
                <span style={{
